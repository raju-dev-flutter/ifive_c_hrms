              ...
              child: Row(
                ...
                children: [
                  navigationGroupButton(
                    ...
                    color:
                        state.index == 0 ? appColor.brand800 : appColor.gray400,
                  ...
                  navigationGroupButton(
                    ...
                    label: 'Home',
                    svgSrc:
                        state.index == 1 ? AppSvg.homeFill : AppSvg.homeOutline,
                    color:
                        state.index == 1 ? appColor.brand800 : appColor.gray400,
                    fontWeight: FontWeight.w500,
                  ),
                  // navigationGroupButton(
                  //   context: context,
                  ...
                  //   label: 'Task',
                  //   svgSrc:
                  //       state.index == 2 ? AppSvg.taskFill : AppSvg.taskOutline,
                  //   color:
                  //       state.index == 2 ? appColor.brand800 : appColor.gray400,
                  //   fontWeight: FontWeight.w500,
                  // ),
                  navigationGroupButton(
                    context: context,
                    ...
                    color:
                        state.index == 3 ? appColor.brand800 : appColor.gray400,
                    fontWeight: FontWeight.w500,
                  ),
                ],
              ),
  ...
  void packageInstaller() async {
    try {
      ...
      RUpgrade.stream.listen((DownloadInfo info) {
        setState(() => {progress = info.percent, status = info.status?.value});
